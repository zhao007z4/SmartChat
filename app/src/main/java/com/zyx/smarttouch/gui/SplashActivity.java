...
public class SplashActivity extends Activity {
	...
	private void runApp() {
		...
		//初始化SDK
		AdManager.getInstance(mContext).init("681cd1e90092f2ba", "0b2dee9047f0fb97", false, false);

        if(SnsApp.mInstance.bShowAd) {
            SnsApp.mInstance.bInit = true;
            //设置开屏
            setupSplashAd();
        }else{
...
//		params.addRule(RelativeLayout.ABOVE, R.id.view_divider);
		...
		// 设置跳转的窗口类
		splashViewSettings.setTargetClass(EntryActivity.class);
		// 设置开屏的容器
