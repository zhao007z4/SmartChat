...
final class CameraConfigurationManager {
  ...
  private static final String TAG = "sns";//CameraConfigurationManager.class.getSimpleName();
   ...
   */
  void initFromCameraParameters(Camera camera,int iWidht,int iHeight) {
    ...
    screenResolution =new Point(iWidht,iHeight);    //new Point(display.getWidth(), display.getHeight());
   ...
   // cameraResolution= getCameraResolution(parameters, screenResolution);
    ...
    paraRotation = -1;
    int degrees; 
    degrees = display.getRotation()*90;
    CameraInfo cameraInfo;
    cameraInfo = FindCamera();
    if(cameraInfo!=null)
    {
    	int orientation= cameraInfo.orientation;
    	previewRotation  = (orientation - degrees + 360) % 360;
    	paraRotation = previewRotation;
		camera.setDisplayOrientation(previewRotation);
		parameters.setRotation(paraRotation);
    }
  }
