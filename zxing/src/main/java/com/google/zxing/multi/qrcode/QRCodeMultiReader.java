...
public final class QRCodeMultiReader extends QRCodeReader implements MultipleBarcodeReader {
  ...
  private static final class SAComparator implements Comparator<Result>, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1505292104492975935L;
    ...
    public int compare(Result a, Result b) {
    	...
    	try
		{
    	      int aNumber = Integer.parseInt(String.valueOf(a.getResultMetadata().get(ResultMetadataType.STRUCTURED_APPEND_SEQUENCE)));
    	      int bNumber = Integer.parseInt(String.valueOf(b.getResultMetadata().get(ResultMetadataType.STRUCTURED_APPEND_SEQUENCE)));
    	      if (aNumber < bNumber) 
    	      {
    	        return -1;
    	      }
